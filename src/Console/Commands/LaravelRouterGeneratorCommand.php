...
namespace Eightyfour600\LaravelRouterGenerator\Console\Commands;
...
class LaravelRouterGeneratorCommand extends Command {
	 ...
	 * @var string
	 */
	protected $description = 'Generate a routes from controller actions if not exists';
	...
	public function fire()
	{
		...
		$route_generator = new LaravelRouterGenerator($method, $uri, $action);
